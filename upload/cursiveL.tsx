...
export default function CursiveL() {
  ...
  const sweepStyle: React.CSSProperties = {
    ...
    opacity: 0,
    filter: 'drop-shadow(0 0 14px #ff33cc) drop-shadow(0 0 24px #fff)',
  }

  return (
    <div style={containerStyle}>
      <div style={innerStyle}>
        <svg viewBox="0 0 26880 11520" style={svgStyle} xmlns="http://www.w3.org/2000/svg">
          <defs>
